...
import { Github, Linkedin, Mail, ExternalLink, Sparkles, Phone } from "lucide-react"
...
const TechStack = memo(({ tech }) => (
  <div className="px-4 py-2 block rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-sm sm:text-sm text-gray-300 hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
...
const SocialLink = memo(({ icon: Icon, link }) => (
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className="group relative p-2">
      <div className="absolute inset-0.5 bg-gradient-to-r from-[#6366f1] to-[#a855f7] rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
      <div className="relative rounded-xl bg-black/50 backdrop-blur-xl p-2 flex items-center justify-center border border-white/10 group-hover:border-white/20 transition-all duration-300">
        <Icon className="w-5 h-5 -mb-0.5 text-gray-400 group-hover:text-white transition-colors" />
      </div>
    </button>
  </a>
));
...
const SOCIAL_LINKS = [
  ...
  { icon: Mail, link: "mailto:jasmine.fakhirah@mhs.unsoed.ac.id" },
  { icon: Phone, link: "https://wa.me/6281934147819" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Crafting Seamless Digital Experiences through Code, Data, and Creative Automation.
                </p>
